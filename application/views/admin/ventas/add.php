                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="comprobantes" id="comprobantes" class="form-control" required>
                                        <option value="">Seleccione...</option>
                                       	<?php foreach ($tipocomprobantes as $tipo_comprobante): ?>
                                       	<?php $datacomprobante = $tipo_comprobante->IdTipoComprobante."*".$tipo_comprobante->Descripcion."*".$tipo_comprobante->igv."*".$tipo_comprobante->UltimoNro."*".$tipo_comprobante->SerieComprobante; ?>

                                       		<option value="<?php echo $datacomprobante; ?>"><?php echo $tipo_comprobante->Descripcion ?></option>
                                       	<?php endforeach; ?>
                                    </select>
                                    <input type="hidden" id="IdTipoComprobante" name="IdTipoComprobante">
                                    <input type="hidden" id="igv">
                                </div>
                                <div class="col-md-3">
                                    <label for="">Serie:</label>
                                    <input type="text" class="form-control" id="SerieComprobante" name="SerieComprobante" readonly>
                                </div>
                                <div class="col-md-3">
                                    <label for="">Numero:</label>
                                    <input type="text" class="form-control" id="UltimoNro" name="UltimoNro" readonly>
                                </div>
                        ...
                        <?php if(!empty($clientes)):?>
                            <?php foreach($clientes as $cliente):?>
                                <tr>
                                    ...
                                    <?php $datacliente = $cliente->IdCliente."*".$cliente->RazonSocial."*".$cliente->NroDocumento."*".$cliente->Telefono."*".$cliente->Direccion;?>
                                    <td>
