        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <p>Si, el producto no se encuentra registrado, hacer click en registra el producto.</p>
                        ...
                        <form action="<?php echo base_url();?>movimientos/compras/store" method="POST" class="form-horizontal">
                            <div class="form-group">
                                <div class="col-md-3">
                                    ...
                                    <select name="comprobantes_compras" id="comprobantes_compras" class="form-control" required>
                                        <option value="">Seleccione...</option>
                                       	<?php foreach ($tipo_comprobantes as $tipo_comprobante): ?>
                                       	<?php $datatipo_comprobante = $tipo_comprobante->IdTipoComprobante."*".$tipo_comprobante->Descripcion."*".$tipo_comprobante->igv."*".$tipo_comprobante->UltimoNro; ?>

                                       		<option value="<?php echo $datatipo_comprobante; ?>"><?php echo $tipo_comprobante->Descripcion ?></option>
                                       	<?php endforeach; ?>
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="UltimoNro" name="UltimoNro">
                                </div>
                                <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="proveedor" id="proveedor" class="form-control" required>
                                        ...
                                        <?php $dataproveedor = $proveedor->IdProveedor."*".$proveedor->RazonSocial."*".$proveedor->Direccion."*".$proveedor->NroDocumento."*".$proveedor->Telefono; ?>

                                            <option value="<?php echo $proveedor->IdProveedor; ?>"><?php echo $proveedor->RazonSocial ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <div class="col-md-3">
                        ...
                        <?php if(!empty($clientes)):?>
                            <?php foreach($clientes as $cliente):?>
                                <tr>
                                    ...
                                    <?php $datacliente = $cliente->IdCliente."*".$cliente->RazonSocial."*".$cliente->tipocliente."*".$cliente->tipodocumento."*".$cliente->Nrodocumento."*".$cliente->Telefono."*".$cliente->Direccion;?>
                                    <td>
